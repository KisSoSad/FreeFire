...
exports.run = async function(o) {
	...
	try{
if (!["1417149937" ].includes(o.event.senderID))return send(`[ MODE ] cần quyền admin chính để sử dụng lệnh này!`);
	switch (o.args[0]) {
		case 'add': {
